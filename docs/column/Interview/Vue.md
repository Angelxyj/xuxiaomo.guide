...
`vue2.x` 和 `vue3.x` 的原理学习，可以参考一下周一大佬的博文，以下是相关专栏文章~
...
关于 `vue` 的相关文章，我在CSDN也输出过很多文章，以下是传送门!

- vue.js大合集 👉[传送门](https://blog.csdn.net/qq_60306931/article/details/130513105)

面试专栏 `pdf` 版本：

- 微信搜索 `许墨工作室` 并关注，回复关键词 `vue面试pdf` 获取相关资料~
