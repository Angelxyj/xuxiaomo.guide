import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.25ff06b1.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"article/backend/nginx/配置相关/1.默认配置.md","filePath":"article/backend/nginx/配置相关/1.默认配置.md","lastUpdated":1707839101000}'),l={name:"article/backend/nginx/配置相关/1.默认配置.md"},o=p(`<p>nginx默认配置文件</p><div class="language-bash vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">server</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">{</span></span>
